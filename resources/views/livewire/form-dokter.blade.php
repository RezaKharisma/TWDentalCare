<div>
    <form action="" method="" class="mt-4" enctype="multipart/form-data">
        <x-input.text layout="H" label="nama lengkap" name="nama" wire:model.debounce.150ms="nama" autofocus required />
        ...
        <x-input.text layout="H" type="date" label="tanggal lahir" name="tanggalLahir" value="{{ date('mm/dd/yyyy') }}" required />
