<div>
    <div class="d-flex align-items-start align-items-sm-center gap-4">
        @if ($foto)
            <img src="{{ $foto->temporaryUrl() }}" alt="user foto" class="d-block rounded img-thumbnail" width="100">
        @else
            <img src="{{ asset('img/userImage.jpg') }}" alt="user foto" class="d-block rounded img-thumbnail" width="100">
        @endif
        <div class="button-wrapper">
            ...
            <button type="button" wire:click='simpan' class="btn btn-primary account-image-reset" {{ $isDisabled ? 'disabled' : '' }}>
                <i class="bx bx-reset d-block d-sm-none"></i>
