...
@if ($layout == 'V' || $layout == 'Vertical')
    <div class="mb-3">
        ...
        <input class="form-control" type="file" name="{{ $name }}" @if ($required) required @endif id="foto" id='imgPreview'>
    </div>
@elseif ($layout == 'H' || $layout == 'Horizontal')
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            ...
            <input class="form-control" type="file" name="{{ $name }}" @if ($required) required @endif id="foto">
        </div>
    </div>
@endif