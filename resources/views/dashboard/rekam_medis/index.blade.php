<x-layouts.main title="Rekam Medis">
    <h4 class="fw-bold py-3">Rekam Medis</h4>

    <div class="row mb-4">
        <div class="col">
            <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#modalInfo"><i
                    class="fa fa-info-circle me-1"></i> Info</button>
            <a class="btn btn-primary" href="/dashboard/rekam_medis/create"><i class="fa fa-plus me-1"></i> Tambah Data</a>
        </div>
    </div>
