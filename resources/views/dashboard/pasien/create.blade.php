                ...
                <div class="card-body">
                    <form class="mt-4">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" placeholder="Masukkan pekerjaan"></textarea>
                            </div>
                        </div>
                        <div class="row justify-content-end">
                            <div class="col-sm-10">
                                <a class="btn btn-secondary" href="/dashboard/pasien"><i class="fa fa-chevron-left me-1"></i> Kembali</a>
